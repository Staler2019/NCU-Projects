...
if __name__ == '__main__':
    ...
    tf.config.experimental.set_visible_devices(devices=gpus[configs.CUDA_VISIBLE_DEVICES], device_type='GPU')
    ...
    if mode == 'train':
        ...
        predictor = Predictor(configs=configs, data_manager=data_manager, logger=logger, bilstm_crf_model=None)
