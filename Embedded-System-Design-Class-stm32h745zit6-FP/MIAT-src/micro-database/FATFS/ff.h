...
#define EOF -1
int fputc_i (int, FIL*);								/* Put a character to the file */
int fputs_i (const char*, FIL*);						/* Put a string to the file */
int fprintf_i (FIL*, const char*, ...);				/* Put a formatted string to the file */
char* fgets_c (char*, int, FIL*);						/* Get a string from the file */
#endif
